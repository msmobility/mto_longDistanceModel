...
public class TripGenerationModel {
    ...
    public TripGenerationModel(ResourceBundle rb, ReadSP syntheticPopulation, MtoLongDistData mtoLongDistData) {
        this.rb = rb;
        this.syntheticPopulationReader = syntheticPopulation;
